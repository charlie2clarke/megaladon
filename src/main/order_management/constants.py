...
HELP_TEXT = "All orders can be seen in the table with awaiting ones at the top. " \
    "Click on the row to see more info on the specific order, or click on the checkbox " \
        "to select one/mutiple orders and then execute one of the listed actions on the "\
            "selected order(s) by clicking the buttons."
